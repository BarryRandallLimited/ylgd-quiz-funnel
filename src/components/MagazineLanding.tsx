 ...
 * frame (no icon), geometric sans (Century Gothic / Futura, Jost as the
 * closest real web font) in uppercase with wide tracking for the logo and
 * headings, Inter for body copy, and the brand green used sparingly as a
 * single accent. Fonts are loaded with a scoped <style> import so nothing
