...
/**
 * Brand-test sibling of QuizLayout.tsx. Same shell/props/logic, restyled
 * with the ink/paper/green brand guide instead of forest-green/gold. See
 * MagazineLandingBrandTest.tsx for the established pattern this mirrors.
 * Not linked anywhere live; used only by the *BrandTest screen components
 * under /quiz-brand-test.
 */

const INK = "#2A2A22";
const PAPER = "#F4EFE4";

interface QuizLayoutBrandTestProps {
...
export default function QuizLayoutBrandTest({
  children,
  imageUrl,
  currentStep,
  totalSteps,
