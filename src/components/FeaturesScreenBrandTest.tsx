...
/**
 * Brand-test sibling of FeaturesScreen.tsx. Same props/logic/copy, restyled
...
interface FeaturesScreenBrandTestProps {
...
export default function FeaturesScreenBrandTest({
  features,
  onToggle,
  onNext,
  onBack,
