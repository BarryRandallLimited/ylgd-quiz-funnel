...
/**
 * Brand-test sibling of EducationScreen.tsx. Same props/logic/copy, restyled
...
interface EducationScreenBrandTestProps {
  eyebrow: string;
  title: string;
  body: string;
  points: string[];
...
export default function EducationScreenBrandTest({
  eyebrow,
  title,
  body,
  points,
