      ...
      <div className="max-w-xl mx-auto px-5 pt-6 pb-10">
        ...
        <div className="mb-6">
          <div className="flex gap-4 items-start mb-5">
            ...
            />
            <div>
              <p className="font-bold text-stone-900 text-[16px]">
                {profile.name}
              </p>
        ...
        <h3 className="text-[1.5rem] leading-tight font-bold text-stone-950 text-center mb-3 text-balance font-display">
          Here's a Realistic Guide to Your Garden's Cost
        </h3>
        ...
        <div
          className="rounded-[1.75rem] p-5 mb-5 shadow-sm"
          style={{ backgroundColor: "#1E3A2F" }}
        >
          ...
          <p className="text-white/65 text-xs text-center leading-relaxed">
            This is a starting figure based on your answers, not a quote. Where
            your garden lands depends on the materials and detail you choose.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 mb-6 shadow-sm">
          <p className="text-[16px] text-stone-700 leading-relaxed text-pretty">
            Two identical gardens can cost very differently. A simpler finish
            keeps it lean. Premium materials and more detail add to it. You
            decide where on that scale you sit, and the design stage is where
        ...
        >
          ...
          <p className="text-[16px] text-stone-700 leading-relaxed text-pretty">
            {profile.firstName} already has your details and your answers.
            He'll call you within one working day to talk through your garden
            and, if it's a fit, scope the design. No obligation, and nothing to
            pay to have the conversation.
          </p>
        </div>
