...
export default function PaymentTrustBadges() {
  return (
    <div className="mt-4 flex flex-col items-center gap-2">
      <div className="flex items-center gap-1.5" style={{ color: "rgba(42,42,34,0.5)" }}>
        <Lock size={12} />
      ...
      <div className="flex items-center gap-2">
        {/* Visa */}
        <div
          className="flex h-6 w-10 items-center justify-center rounded-md bg-white"
          style={{ border: "1px solid rgba(42,42,34,0.15)" }}
        >
        ...
        {/* Stripe */}
        <div
          className="flex h-6 items-center rounded-md bg-white px-2"
          style={{ border: "1px solid rgba(42,42,34,0.15)" }}
        >
