...
/**
 * Brand-test sibling of ContactScreen.tsx. Same props, validation logic,
 * state, and copy exactly as-is - only visual styling changes. This is the
 * most logic-heavy screen, so business logic here must match the original
 * component line for line.
 */
...
interface ContactScreenBrandTestProps {
...
export default function ContactScreenBrandTest({
  onSubmit,
  onBack,
  currentStep,
  totalSteps,
