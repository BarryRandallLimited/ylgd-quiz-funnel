...
/**
 * Brand-test sibling of PostcodeScreen.tsx. Same props/validation logic/copy,
...
interface PostcodeScreenBrandTestProps {
  eyebrow: string;
  question: string;
  hint: string;
  placeholder: string;
...
export default function PostcodeScreenBrandTest({
  eyebrow,
  question,
  hint,
  placeholder,
